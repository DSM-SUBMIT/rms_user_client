...
const WritePlan: FC<DetailPlanState> = props => {
  const { content, goal, projectName } = props;
        ...
        <S.Form name='plan' method='post'>
          <S.Plan>
            ...
            <S.PlanContent>
              <h4>프로젝트 내용</h4>
              <textarea
                placeholder='프로젝트의 내용을 구체적으로 작성해주세요'
                onChange={e => {
              ...
              <S.InputDiv>
                <div>
                  <input
                    type='checkbox'
                    id='report'
                    checked={state.includeResultReport}
                    onChange={e => {
